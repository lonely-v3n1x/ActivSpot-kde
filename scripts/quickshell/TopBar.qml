	    ...
	    Process { id: networkWaiter; command: ["bash", "-c", "~/.config/hypr/scripts/quickshell/watchers/network_wait.sh"]; onExited: networkPoller.running = true }
            ...
            Item {
                ...
                Item {
                    ...
                    // Width must match DynamicIsland.qml's collapsedW formula.
                    width: {
                    ...
                    Rectangle {
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                MouseArea { id: kbMouse; anchors.fill: parent; hoverEnabled: true; onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/hypr/scripts/quickshell/compositor_backend.sh switch_keyboard_next"]) }
                            }
